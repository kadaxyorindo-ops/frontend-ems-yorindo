...
export function Surveys() {
  return (
    <DashboardLayout>
      <title>Yorindo EMS - Survey & Analytics</title>
      <div className="space-y-6 flex flex-col h-full">
        <div className="mb-6 pb-2 border-b border-dashed border-slate-200">
          <h1 className="text-4xl font-bold tracking-tight text-[#001a4e]">Surveys & Analytics</h1>
          <p className="max-w-2xl text-sm leading-6 text-slate-500">View survey results and event analytics reports.</p>
        </div>
